...
public partial class PontoBlockReportsService
{
    ...
    public static async Task<PontoBlockReportsService> DeployContractAndGetServiceAsync(
        Nethereum.Web3.Web3 web3, 
        PontoBlockReportsDeployment pontoBlockReportsDeployment, 
        CancellationTokenSource? cancellationTokenSource = null)
    {
    ...
    public Task<GetWorkTimeFromEmployeeBetweenTwoDatesOutputDTO> GetWorkTimeFromEmployeeBetweenTwoDatesQueryAsync(
        GetWorkTimeFromEmployeeBetweenTwoDatesFunction getWorkTimeFromEmployeeBetweenTwoDatesFunction, 
        BlockParameter? blockParameter = null)
    {
        return ContractHandler
            .QueryDeserializingToObjectAsync<GetWorkTimeFromEmployeeBetweenTwoDatesFunction, GetWorkTimeFromEmployeeBetweenTwoDatesOutputDTO>(
                getWorkTimeFromEmployeeBetweenTwoDatesFunction, 
                blockParameter);
    }
    public Task<GetWorkTimeFromEmployeeBetweenTwoDatesOutputDTO> GetWorkTimeFromEmployeeBetweenTwoDatesQueryAsync(
        string employee, 
    ...
    public Task<GetWorkTimesForAllEmployeesAtDateOutputDTO> GetWorkTimesForAllEmployeesAtDateQueryAsync(
        GetWorkTimesForAllEmployeesAtDateFunction getWorkTimesForAllEmployeesAtDateFunction, 
        BlockParameter? blockParameter = null)
    {
        return ContractHandler.QueryDeserializingToObjectAsync<GetWorkTimesForAllEmployeesAtDateFunction, GetWorkTimesForAllEmployeesAtDateOutputDTO>(getWorkTimesForAllEmployeesAtDateFunction, blockParameter);
    }
    public Task<GetWorkTimesForAllEmployeesAtDateOutputDTO> GetWorkTimesForAllEmployeesAtDateQueryAsync(BigInteger date, BlockParameter? blockParameter = null)
    {
        ...
        return ContractHandler.QueryDeserializingToObjectAsync<GetWorkTimesForAllEmployeesAtDateFunction, GetWorkTimesForAllEmployeesAtDateOutputDTO>(
            getWorkTimesForAllEmployeesAtDateFunction, 
            blockParameter);
    }
    public Task<GetWorkTimesForAllEmployeesBetweenTwoDatesOutputDTO> GetWorkTimesForAllEmployeesBetweenTwoDatesQueryAsync(
        GetWorkTimesForAllEmployeesBetweenTwoDatesFunction getWorkTimesForAllEmployeesBetweenTwoDatesFunction, 
        BlockParameter? blockParameter = null)
    {
        return ContractHandler
            .QueryDeserializingToObjectAsync<GetWorkTimesForAllEmployeesBetweenTwoDatesFunction, GetWorkTimesForAllEmployeesBetweenTwoDatesOutputDTO>(
                getWorkTimesForAllEmployeesBetweenTwoDatesFunction, 
                blockParameter);
    }
    public Task<GetWorkTimesForAllEmployeesBetweenTwoDatesOutputDTO> GetWorkTimesForAllEmployeesBetweenTwoDatesQueryAsync(
        BigInteger startDate, 
    ...
    public Task<GetWorkTimesFromEmployeeAtDateOutputDTO> GetWorkTimesFromEmployeeAtDateQueryAsync(
        GetWorkTimesFromEmployeeAtDateFunction getWorkTimesFromEmployeeAtDateFunction, 
        BlockParameter? blockParameter = null)
    {
        return ContractHandler
            .QueryDeserializingToObjectAsync<GetWorkTimesFromEmployeeAtDateFunction, GetWorkTimesFromEmployeeAtDateOutputDTO>(
                getWorkTimesFromEmployeeAtDateFunction, 
                blockParameter);
    }
    public Task<GetWorkTimesFromEmployeeAtDateOutputDTO> GetWorkTimesFromEmployeeAtDateQueryAsync(
        string employee, 
