...
public partial class PontoBlockService
{
    ...
    public static async Task<PontoBlockService> DeployContractAndGetServiceAsync(
        Nethereum.Web3.Web3 web3, 
        PontoBlockDeployment pontoBlockDeployment, 
        CancellationTokenSource? cancellationTokenSource = null)
    {
    ...
    public Task<TransactionReceipt> BreakEndTimeRequestAndWaitForReceiptAsync(
    ...
    public Task<TransactionReceipt> BreakStartTimeRequestAndWaitForReceiptAsync(
    ...
    public Task<TransactionReceipt> EndWorkRequestAndWaitForReceiptAsync(EndWorkFunction endWorkFunction, CancellationTokenSource? cancellationToken = null)
    {
    ...
    public Task<BigInteger> GetCreationDateContractQueryAsync(
    ...
    public Task<GetEmployeeRecordsOutputDTO> GetEmployeeRecordsQueryAsync(
        GetEmployeeRecordsFunction getEmployeeRecordsFunction, 
        BlockParameter? blockParameter = null)
    {
        return ContractHandler
            .QueryDeserializingToObjectAsync<GetEmployeeRecordsFunction, GetEmployeeRecordsOutputDTO>(getEmployeeRecordsFunction, blockParameter);
    }
    public Task<GetEmployeeRecordsOutputDTO> GetEmployeeRecordsQueryAsync(string address, BigInteger date, BlockParameter? blockParameter = null)
    {
    ...
    public Task<BigInteger> GetMomentQueryAsync(GetMomentFunction getMomentFunction, BlockParameter? blockParameter = null)
    {
    ...
    public Task<BigInteger> GetTimeZoneQueryAsync(GetTimeZoneFunction getTimeZoneFunction, BlockParameter? blockParameter = null)
    {
    ...
    public Task<TransactionReceipt> StartWorkRequestAndWaitForReceiptAsync(
