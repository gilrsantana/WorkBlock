...
public partial class EmployerContractService
{
    ...
    {
        return web3.Eth.GetContractDeploymentHandler<EmployerContractDeployment>().SendRequestAndWaitForReceiptAsync(employerContractDeployment, cancellationTokenSource);
    }
    ...
    public static async Task<EmployerContractService> 
    ...
    public Task<TransactionReceipt> 
        AddEmployerRequestAndWaitForReceiptAsync(
    ...
    public Task<bool> 
        CheckIfEmployerExistsQueryAsync(
    ...
    public Task<GetAllEmployersOutputDTO> 
        GetAllEmployersQueryAsync(
            GetAllEmployersFunction getAllEmployersFunction, 
            BlockParameter? blockParameter = null)
    {
        return ContractHandler.QueryDeserializingToObjectAsync<GetAllEmployersFunction, GetAllEmployersOutputDTO>(getAllEmployersFunction, blockParameter);
    }
    ...
    public Task<GetEmployerByAddressOutputDTO> 
        GetEmployerByAddressQueryAsync(
            GetEmployerByAddressFunction getEmployerByAddressFunction, 
            BlockParameter? blockParameter = null)
    {
        return ContractHandler.QueryDeserializingToObjectAsync<GetEmployerByAddressFunction, GetEmployerByAddressOutputDTO>(getEmployerByAddressFunction, blockParameter);
    }
    ...
    public Task<GetEmployerByIdOutputDTO> 
        GetEmployerByIdQueryAsync(
            GetEmployerByIdFunction getEmployerByIdFunction, 
            BlockParameter? blockParameter = null)
    {
    ...
    public Task<TransactionReceipt> 
        UpdateEmployerRequestAndWaitForReceiptAsync(
