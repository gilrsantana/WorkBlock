...
public partial class AdministratorContractService
{
    ...
    {
        return web3.Eth
            .GetContractDeploymentHandler<AdministratorContractDeployment>()
            .SendRequestAndWaitForReceiptAsync(administratorContractDeployment, cancellationTokenSource);
    }

    public static Task<string> 
        DeployContractAsync(Nethereum.Web3.Web3 web3, 
            AdministratorContractDeployment administratorContractDeployment)
    {
        return web3.Eth
            .GetContractDeploymentHandler<AdministratorContractDeployment>()
            .SendRequestAsync(administratorContractDeployment);
    }

    public static async Task<AdministratorContractService> 
    ...
    public Task<TransactionReceipt> 
        AddAdministratorRequestAndWaitForReceiptAsync(AddAdministratorFunction addAdministratorFunction, 
    ...
    public Task<TransactionReceipt> 
        AddAdministratorRequestAndWaitForReceiptAsync(string address, 
            string name, 
            BigInteger taxId, 
            CancellationTokenSource? cancellationToken = null)
    {
    ...
    public Task<bool> 
        CheckIfAdministratorExistsQueryAsync(CheckIfAdministratorExistsFunction checkIfAdministratorExistsFunction, 
    ...
    public Task<bool> 
        CheckIfAdministratorExistsQueryAsync(string address, 
            BlockParameter? blockParameter = null)
    {
    ...
    public Task<bool> 
        CheckIfAdministratorIsActiveQueryAsync(CheckIfAdministratorIsActiveFunction checkIfAdministratorIsActiveFunction,
            BlockParameter? blockParameter = null)
    {
    ...
    public Task<bool> 
        CheckIfAdministratorIsActiveQueryAsync(string address, 
            BlockParameter? blockParameter = null)
    {
    ...
    public Task<GetAdministratorOutputDTO> 
        GetAdministratorQueryAsync(GetAdministratorFunction getAdministratorFunction, 
            BlockParameter? blockParameter = null)
    {
        return ContractHandler.QueryDeserializingToObjectAsync<GetAdministratorFunction, GetAdministratorOutputDTO>(getAdministratorFunction, blockParameter);
    }

    public Task<GetAdministratorOutputDTO> 
        GetAdministratorQueryAsync(BigInteger id, 
            BlockParameter? blockParameter = null)
    {
    ...
    public Task<GetAllAdministratorsOutputDTO> 
        GetAllAdministratorsQueryAsync(GetAllAdministratorsFunction getAllAdministratorsFunction, 
            BlockParameter? blockParameter = null)
    {
        return ContractHandler.QueryDeserializingToObjectAsync<GetAllAdministratorsFunction, GetAllAdministratorsOutputDTO>(getAllAdministratorsFunction, blockParameter);
    }
    ...
    public Task<TransactionReceipt> 
        UpdateAdministratorRequestAndWaitForReceiptAsync(UpdateAdministratorFunction updateAdministratorFunction, 
            CancellationTokenSource? cancellationToken = null)
    {
    ...
    public Task<TransactionReceipt> 
        UpdateAdministratorRequestAndWaitForReceiptAsync(string addressKey, 
            string address, 
            BigInteger taxId, 
            string name, 
            byte state, 
