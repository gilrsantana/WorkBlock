...
public partial class EmployeeContractService
{
    ...
    {
        return web3.Eth
            .GetContractDeploymentHandler<EmployeeContractDeployment>().SendRequestAndWaitForReceiptAsync(employeeContractDeployment, cancellationTokenSource);
    }
    ...
    public static async Task<EmployeeContractService> DeployContractAndGetServiceAsync(
        Nethereum.Web3.Web3 web3, 
        EmployeeContractDeployment employeeContractDeployment, 
        CancellationTokenSource? cancellationTokenSource = null)
    {
    ...
    public Task<bool> CheckIfEmployeeExistsQueryAsync(CheckIfEmployeeExistsFunction checkIfEmployeeExistsFunction, BlockParameter? blockParameter = null)
    {
        return ContractHandler.QueryAsync<CheckIfEmployeeExistsFunction, bool>(checkIfEmployeeExistsFunction, blockParameter);
    }
    
    public Task<bool> CheckIfEmployeeExistsQueryAsync(string address, BlockParameter? blockParameter = null)
    {
    ...
    public Task<GetAllEmployeesOutputDTO> GetAllEmployeesQueryAsync(GetAllEmployeesFunction getAllEmployeesFunction, BlockParameter? blockParameter = null)
    {
    ...
    public Task<GetEmployeeByAddressOutputDTO> GetEmployeeByAddressQueryAsync(
        GetEmployeeByAddressFunction getEmployeeByAddressFunction, 
        BlockParameter? blockParameter = null)
    {
        return ContractHandler
            .QueryDeserializingToObjectAsync<GetEmployeeByAddressFunction, GetEmployeeByAddressOutputDTO>(getEmployeeByAddressFunction, blockParameter);
    }
    public Task<GetEmployeeByAddressOutputDTO> GetEmployeeByAddressQueryAsync(string address, BlockParameter? blockParameter = null)
    {
    ...
    public Task<GetEmployeeByIdOutputDTO> GetEmployeeByIdQueryAsync(GetEmployeeByIdFunction getEmployeeByIdFunction, BlockParameter? blockParameter = null)
    {
    ...
    public Task<GetEmployeeByIdOutputDTO> GetEmployeeByIdQueryAsync(BigInteger id, BlockParameter? blockParameter = null)
    {
    ...
    public Task<string> GetEmployerContractQueryAsync(GetEmployerContractFunction getEmployerContractFunction, BlockParameter? blockParameter = null)
    {
