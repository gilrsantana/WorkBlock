...
public class EmployeeUpdatedEventMap : IEntityTypeConfiguration<EmployeeUpdatedEventModel>
{
    public void Configure(EntityTypeBuilder<EmployeeUpdatedEventModel> builder)
    {
        builder.ToTable("EmployeeUpdatedEvent");
