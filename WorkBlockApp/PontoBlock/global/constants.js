...
export const pontoBlockAddress = "0x2088d2a155a9aE24F700DF7A29c4F689316a22F4";
...
export const pontoBlockReportsAddress =
  "0xe6573797c6Ca4F3CFdf02b56ae915857e34706Fd";

export const pontoBlockReportsABI = [
  {
    inputs: [
      { internalType: "address", name: "_emp", type: "address" },
      { internalType: "address", name: "_ponto", type: "address" },
      { internalType: "address", name: "_util", type: "address" },
      { internalType: "address", name: "_adm", type: "address" },
    ],
    stateMutability: "nonpayable",
  ...
  },
  {
    ...
    outputs: [
      { internalType: "uint256[]", name: "_date", type: "uint256[]" },
      { internalType: "uint256[]", name: "_startWork", type: "uint256[]" },
      { internalType: "uint256[]", name: "_endWork", type: "uint256[]" },
      { internalType: "uint256[]", name: "_breakStartTime", type: "uint256[]" },
      { internalType: "uint256[]", name: "_breakEndTime", type: "uint256[]" },
    ],
    stateMutability: "view",
    type: "function",
  },
  {
    ...
    outputs: [
      { internalType: "address[]", name: "_empAddress", type: "address[]" },
      { internalType: "uint256[]", name: "_startWork", type: "uint256[]" },
      { internalType: "uint256[]", name: "_endWork", type: "uint256[]" },
      { internalType: "uint256[]", name: "_breakStartTime", type: "uint256[]" },
      { internalType: "uint256[]", name: "_breakEndTime", type: "uint256[]" },
...
export const utilAddress = "0x928F9Ba98E76daC279124546b229B68922B6753b";
...
export const utilABI = [
  {
    ...
    name: "getDate",
    outputs: [
      { internalType: "uint256", name: "yearMonthDay", type: "uint256" },
    ],
