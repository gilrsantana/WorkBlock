...
using WorkBlockApresentacao.Interfaces;

namespace WorkBlockApresentacao.Models
{
    public class EmailModel : IEmail
    {
        ...
        public EmailModel(string provedor, string username, string password)
        {
        ...
        private MailMessage PrepareteMessage(List<string> emailsTo, string subject, string body, List<string> attachments = null)
        {
